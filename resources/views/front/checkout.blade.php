                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="form-input form">
                                                    <x-form.select name="addr[billing][country]" selected="EGY" :options="$countries" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-form form-default">
                                                <label>Country</label>
                                                <div class="form-input form">
                                                    <x-form.select name="addr[shipping][country]" selected="EGY" :options="$countries" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{\App\Helpers\Currency::formatCurrency($cart->total())}}</p>
                                </div>
                                <div class="total-price shipping">
                                    <p class="value">Subotal Price:</p>
                                    <p class="price">{{\App\Helpers\Currency::formatCurrency(0)}}</p>
                                </div>
