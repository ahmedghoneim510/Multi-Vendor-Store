    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="{{asset('dist/img/photo_2023-08-17_18-46-04.jpg')}}" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
                    <a href="{{route('dashboard.profile.edit')}}" class="d-block " @style('text-decoration: underline') >{{Auth::user()->name}}</a>
            ...
            <x-nav/>
{{--            get nav form class and component--}}
